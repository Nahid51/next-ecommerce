            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
                ...
                <div className="h-[2px] bg-gray-100" />
                {
                    product?.priceData?.price === product?.priceData?.discountedPrice ? (
                        <h3 className=" font-medium text-2xl">{product?.priceData?.currency}{product?.priceData?.price}</h3>
                    ) :
                        <div className="flex items-center gap-4">
                            <h3 className="text-xl text-gray-500 line-through">{product?.priceData?.currency} {product?.priceData?.price}</h3>
                            <h3 className=" font-medium text-2xl">{product?.priceData?.currency} {product?.priceData?.discountedPrice}</h3>
                        </div>
                }
